...
pdam_pars <- expand_grid(
  ...
  v_ind = seq(0, 3, 0.25),              # Test broad v_ind (relative to v_pop = 1; Pdam estimate = 1.57)
  v_err = v_err_rel, #seq(0.06, 0.27, 0.1),        # Meas. err. variance on rel. scale (95% CI of v_err_abs / v_pop_abs)  COULD ALSO JUST USE POINT ESTIMATE INSTEAD OF CI...
...
# Run bootstrap
set.seed(123)
boot_out <- boot(data = pdam, statistic = blomqvist_boot_scaled, R = 1000)
...
evaluate_methods <- function(b_true, v_pop, v_ind, v_err, seed, n = 200, reps = 25) {
