...
* A true relationship with minimal individual variance or measurement error is reflected accurately in the observed relationship. However, Kelly-Price still interprets the variance in change as being due to measurement error, and attempts to correct for regression to the mean, yielding a much weaker relationship (almost zero!). Blomqvist gets it right.  
...
results_long <- results_grid %>%
  ...
  mutate(v_ind = factor(v_ind, levels = c(2, 0.5, 0.01)))
