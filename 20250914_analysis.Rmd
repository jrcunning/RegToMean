...
annotate(
  "text",
  x = 1.5, y = Inf,
  label = paste0("s[2]/s[1]==", round(theta, 3)),
  parse = TRUE,
...
ggsave(filename = "fig2alt.png", width = 160, height = 120, units = "mm", bg = "white")
...
pdam_chiolero_plot <- chiolero_plot(pdam, log_init_obs, log_final_obs) + 
  ...
  "text",
  x = 1.5, y = Inf,
  label = paste0("s[2]/s[1]==", round(pdam_theta, 3)),
  parse = TRUE,
  hjust = 0.5, vjust = 2, size = 2
)
...
mill_chiolero_plot <- chiolero_plot(mill, log_init_obs, log_final_obs) + 
  ...
  "text",
  x = 1.5, y = Inf,
  label = paste0("s[2]/s[1]==", round(mill_theta, 3)),
  parse = TRUE,
  hjust = 0.5, vjust = 2, size = 2
)
