...
pdam_plots <- cowplot::plot_grid(
  text_panel_math(
    ...
    line5 = sprintf("s[X]^2==bold(%s)", formatC(pdam_var_x_abs - pdam_v_err_abs, format = "fg", digits = 3)),
...
mill_plots <- cowplot::plot_grid(
  text_panel_math(
    ...
    line5 = sprintf("s[X]^2==bold(%s)", formatC(mill_var_x_abs - mill_v_err_abs, format = "fg", digits = 3)),
