...
ggsave(filename = "figures/fig1.png", width = 17, height = 11.9, units = "cm", bg = "white")
```
...
ggsave(filename = "figures/fig2.png", plot = fig2, width = 12, height = 9, units = "cm", bg = "white")
...
ggsave(filename = "figures/fig3.png", width = 17, height = 6.8, units = "cm", bg = "white")
```
